...
const JLPTDecks = {
  /* 
    ...
    七 車 十 出 女 小 上 人 水 生 先 千 川 大 男 中 天 土 二 日 入 年 白 八 百 本 名 木 六 何 外 間 午 後 語 行 高 国 今 時 書 食 西 前 長 電 東 読 南 半 父 分 聞 母 北 毎 万 友 来 話
  */
  "n5": {
    "name": "JLPT 5",
    "kanji": getKanji(["一", "右", "雨", "円", "下", "火", "学", "気", "休", "金", "九", "月", "見", "五", "校", "左", "三", "山", "四", "子"]),
    "method": "jlpt",
  }
}
